...
public class Toucah : MonoBehaviour
{
    ...
    void checkTNLine1()
    {
        ...
        Vector3 boxtn = new Vector3(0.5f, 0.5f, 1f);
    ...
    void CheckNoteInLine(int lineIndex)
    {
        ...
        Vector3 boxSizePerfect = new Vector3(0.5f, 0.8f, 1f);
        Vector3 boxSizeGreat = new Vector3(0.5f, 1.25f, 1f);
        Vector3 boxSizeGood = new Vector3(0.5f, 2f, 1f);
    ...
    {
        Vector3 boxCenter = new Vector3(0f, -4.5f, 0f);
